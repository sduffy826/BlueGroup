...
public class JavaGetGroupsForEmail extends Processor
{
    ...
    */
   public Class<EMailBean> getBeanForInput(Link inputLink)
   {
    ...
    * @return A {@link Class} of bean class.
    */
   public Class<GroupOwnerBean> getBeanForOutput(Link outputLink)
   {
      return GroupOwnerBean.class;
   }
}